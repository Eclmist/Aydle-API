...
class MonsterRaid extends GenericGame{
    ...
    setupGameHandlers(socket,io){
        ...
        currentPlayer.gameStateObject.socketID = socket.id;
        currentPlayer.gameStateObject.waveNumber = 1;
        currentPlayer.gameStateObject.waveObject = [];
        currentPlayer.gameStateObject.reactionTimer = this.MAX_TIME_TO_REACT;
        currentPlayer.gameStateObject.hasTimerStarted = false;
        currentPlayer.gameStateObject.isWaiting = false;
